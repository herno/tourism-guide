...
public class Stories_DataBaseHandler extends SQLiteOpenHelper {
	...
	private static final String KEY_Historical_place_ID = "historical_place_id";

	public Stories_DataBaseHandler(Context context) {
	...
	void addContact(Contact contact) {
		...
		values.put(KEY_Historical_place_ID, contact.getPhoneNumber()); // Contact Phone
	...
	Contact getContact(int id) {
		...
		Cursor cursor = db.query(TABLE_STORIES, new String[] { KEY_ID,
				KEY_NAME, KEY_Historical_place_ID }, KEY_ID + "=?",
	...
	public int updateContact(Contact contact) {
		...
		values.put(KEY_Historical_place_ID, contact.getPhoneNumber());
